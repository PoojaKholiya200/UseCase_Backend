...
@NamedQuery(name="User.getAllTeacher", query= "select new com.inn.school.wrapper.UserWrapper( u.name, u.email, u.contactNumber) from User u where u.role='teacher' ")
